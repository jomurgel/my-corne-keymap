...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_split_3x6_3(
            ...
            KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,              KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_LALT,
                           KC_LGUI, TO(1), KC_SPC,              KC_ENT, TO(0), KC_LCTL
        ),
        [1] = LAYOUT_split_3x6_3(
            KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5,               KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC,
            KC_TAB, KC_NO, KC_NO, KC_PIPE, KC_DQUO,             KC_LBRC, KC_RBRC, KC_QUOT, KC_BSLS, KC_NO, KC_NO,
            KC_RSFT, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_LPRN,     KC_MINS, KC_EQL, KC_RPRN, KC_NO, KC_NO, KC_NO,
                           KC_LALT, KC_LGUI, MO(2),             KC_SPC, KC_ENT, TO(0), KC_LCTL
        ),
        [2] = LAYOUT_split_3x6_3(
            ...
            KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,         KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_LALT,
                            KC_LGUI, KC_TRNS, KC_SPC,           KC_ENT, TO(0), KC_LCTL
        ),
