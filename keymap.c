...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CTL_GUI] = ACTION_TAP_DANCE_DOUBLE(KC_LCTL, KC_GUI),
 ...
 *                                                                               generated by [keymapviz] */
        ...
        [1] = LAYOUT_split_3x6_3(KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, TD(TD_ALT_ESC), KC_NO, KC_PIPE, KC_PLUS, KC_LBRC, KC_TILD, KC_GRV, KC_RBRC, KC_EQL, KC_BSLS, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_LPRN, KC_UNDS, KC_MINS, KC_RPRN, KC_NO, KC_NO, KC_NO, KC_RSFT, TD(TD_CTL_GUI), KC_TRNS, TD(TD_SPC_CMD), KC_RSFT, KC_TRNS, TD(TD_GUI_CTL)),
