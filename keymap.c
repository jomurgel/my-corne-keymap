...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_H] = ACTION_TAP_DANCE_DOUBLE(KC_H, LGUI(KC_H)),
 ...
 *                                                                               generated by [keymapviz] */
        [0] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, TD(TD_U), TD(TD_I), KC_O, KC_P, KC_BSPC, TD(TD_ALT_ESC), TD(TD_A), KC_S, KC_D, KC_F, KC_G, TD(TD_H), KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, TD(TD_Z), KC_X, TD(TD_C), TD(TD_V), TD(TD_B), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, TD(TD_SFT_CAPS), TD(TD_CTL_GUI), MO(1), KC_SPC, KC_ENT, MO(2), TD(TD_GUI_CTL)),
/* ,-----------------------------------------.                ,-----------------------------------------.
 ...
 *                                                                               generated by [keymapviz] */
        ...
        [1] = LAYOUT_split_3x6_3(KC_TAB, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, TD(TD_ALT_ESC), KC_NO, KC_PIPE, KC_PLUS, KC_TILD, KC_LBRC, KC_RBRC, KC_GRV, KC_EQL, KC_BSLS, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_LPRN, KC_UNDS, KC_MINS, KC_RPRN, KC_NO, KC_NO, KC_NO, TD(TD_SFT_CAPS), TD(TD_CTL_GUI), KC_TRNS, KC_SPC, KC_RSFT, KC_TRNS, TD(TD_GUI_CTL)),
 ...
 *                             `--------------------'  `--------------------'
 *                                                                               generated by [keymapviz] */
        [2] = LAYOUT_split_3x6_3(KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_NO, KC_NO, KC_UP, KC_NO, KC_NO, KC_BSPC, TD(TD_ALT_ESC), KC_CAPS, KC_F6, KC_F7, KC_F8, KC_F9, TO(3), KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_LSFT, KC_F10, KC_F11, KC_F12, KC_F14, KC_F15, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TD(TD_SFT_CAPS), TD(TD_CTL_GUI), KC_TRNS, KC_SPC, KC_ENT, KC_TRNS, TD(TD_GUI_CTL)),
